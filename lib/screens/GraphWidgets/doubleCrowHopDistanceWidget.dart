...
class DoubleCrowHopDistanceWidget extends StatefulWidget {
  const DoubleCrowHopDistanceWidget({Key? key}) : super(key: key);

  @override
  State<DoubleCrowHopDistanceWidget> createState() =>
      _DoubleCrowHopDistanceWidgetState();
}

class _DoubleCrowHopDistanceWidgetState
    extends State<DoubleCrowHopDistanceWidget> {
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
      ...
      title: ChartTitle(text: 'Double Crow Hop Distance'),
