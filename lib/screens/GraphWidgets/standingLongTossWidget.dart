...
class StandingLongTossWidget extends StatefulWidget {
  const StandingLongTossWidget({Key? key}) : super(key: key);

  @override
  State<StandingLongTossWidget> createState() => _StandingLongTossWidgetState();
}

class _StandingLongTossWidgetState extends State<StandingLongTossWidget> {
  ...
  Widget build(BuildContext context) {
    return SfCartesianChart(
      ...
      title: ChartTitle(text: 'Standing Long Toss'),
