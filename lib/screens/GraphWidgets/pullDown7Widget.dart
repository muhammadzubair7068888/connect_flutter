...
class PullDown7Widget extends StatefulWidget {
  const PullDown7Widget({Key? key}) : super(key: key);

  @override
  State<PullDown7Widget> createState() => _PullDown7WidgetState();
}

class _PullDown7WidgetState extends State<PullDown7Widget> {
